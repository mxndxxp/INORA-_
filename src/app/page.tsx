  ...
  return (
    <div className="flex flex-col min-h-[100dvh]">
      <section className="relative w-full min-h-[90vh] md:min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute top-1/2 -translate-y-1/2 left-4 md:left-8 lg:left-16 hidden md:flex flex-col gap-6 z-30">
        ...
        <div className="absolute top-1/2 -translate-y-1/2 right-4 md:right-8 lg:right-16 hidden md:flex flex-col gap-6 z-30">
